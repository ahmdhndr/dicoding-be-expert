...
describe('A calculateRectangleArea function', () => {
  ...
  it('should return correct value based on rectangle area formula', () => {
    ...
    // Assert
    expect(result).toEqual(150); // (length * width)
    expect(spyMultiply).toHaveBeenCalledWith(10, 15);
  });
});
...
describe('A calculateTrianglePerimeter function', () => {
  ...
  it('should throw error when given with non-number parameters', () => {
    ...
    expect(() => figureCalculator.calculateTrianglePerimeter('2', null, [])).toThrowError();
  ...
  it('should return correct value based on triangle perimeter formula', () => {
    ...
    // Assert
    expect(result).toEqual(30); // (sideA + sideB) + base
    expect(spyAdd).toHaveBeenCalledWith(25, 5); // (sideA + sideB)
  });
});
...
describe('A calculateTriangleArea function', () => {
  ...
  it('should throw error when given with non-number parameters', () => {
    ...
    expect(() => figureCalculator.calculateTriangleArea('2', null)).toThrowError();
    expect(() => figureCalculator.calculateTriangleArea([], '1')).toThrowError();
  ...
  it('should return correct value based on triangle area formula', () => {
    ...
    expect(spyMultiply).toHaveBeenCalledWith(2, 10);
